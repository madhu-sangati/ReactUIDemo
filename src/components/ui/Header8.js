...
const useStyles = makeStyles(theme => ({
    ...
    menu: {
        ...
        color: "inherit",
        borderRadius: "0px",
        top: "70px !important;" //for sub-menu not overlapping main-menu
    },
    menuItem: {
        ...theme.typography.tab,
        opacity: 0.7,
...
export default function Header(props) {
    ...
    // const [value, setValue] = useState(0); //this is moved to app.js, bco'z it is used in more components
    const [anchorEl, setAnchorEl] = useState(null);
    // const [open, setOpen] = useState(false); //before change
    const [openMenu, setOpenMenu] = useState(false); //After change
    // const [selectedIndex, setSelectedIndex] = useState(0); //this is moved to app.js, bco'z it is used in more components
